...
describe('Nested matcher', () => {
  ...
  describe('.prototype.toTree()', () => {
    describe('given nesteds with toTree', () => {
      test('returns a nested String of the Nested and its matchers', () => {
        const innerNested = new Nested()
        innerNested.toString = () => 'inner'
        const matchers = [innerNested]
        const nested = new Nested(...matchers)
    ...
    describe('given nesteds with toString', () => {
      it('returns a nested String of the Nested and its matchers', () => {
